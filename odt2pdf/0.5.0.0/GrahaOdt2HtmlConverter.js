...
GrahaOdt2HtmlConverter.prototype.init = function(fontFamilyConverter) {
...
GrahaOdt2HtmlConverter.prototype.finalizeTableBorder = function() {
	var _this = this;
	...
	return new Promise(function(resolve, reject) {
		window.setTimeout(function() {
			try {
				if(window.document.documentMode) {
					$(_this.wrapperSelector + " td").each(function() {
						var minimumBorderWidth = 0.5;
						if($(this).css("border-top-width") != "0px") {
							var border = _this.parseFloat($(this).css("border-top-width"), 0);
							if(border > 0 && border <= minimumBorderWidth) {
								$(this).css("border-top-width", minimumBorderWidth + "px");
							}
						}
						if($(this).css("border-bottom-width") != "0px") {
							var border = _this.parseFloat($(this).css("border-bottom-width"), 0);
							if(border > 0 && border <= minimumBorderWidth) {
								$(this).css("border-bottom-width", minimumBorderWidth + "px");
							}
						}
						if($(this).css("border-left-width") != "0px") {
							var border = _this.parseFloat($(this).css("border-left-width"), 0);
							if(border > 0 && border <= minimumBorderWidth) {
								$(this).css("border-left-width", minimumBorderWidth + "px");
							}
						}
						if($(this).css("border-right-width") != "0px") {
							var border = _this.parseFloat($(this).css("border-right-width"), 0);
							if(border > 0 && border <= minimumBorderWidth) {
								$(this).css("border-right-width", minimumBorderWidth + "px");
							}
						}
					});
				}
		...
		window.setTimeout(function() {
			try {
				$(_this.wrapperSelector + " table").each(function() {
					if($(this).css("border-collapse") != null && $(this).css("border-collapse") == "collapse") {
			...
			_this.finalizeParagraphFontSize().then(function() {
				_this.finalizeDrawFrameHeight().then(function() {
					_this.finalizeCollapseTableBorder().then(function() {
						_this.finalizeTableBorder().then(function() {
