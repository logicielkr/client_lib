...
필자가 만들어서 배포중인 [GrahaReporter.js](https://github.com/logicielkr/client_lib/tree/master/reporter/0.5.0.4)
...
2. 한글 서체는 나눔폰트를 사용한다.
	...
	폰트에 따라 문자의 width 가 달라지기 때문에 발생하는 문제들이 있다.
